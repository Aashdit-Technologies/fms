...
//       const newValue = !prevSelected[item.id]; // Toggle current item
  
//       newSelectedItems[item.id] = newValue; // Update current selection
...
//       // ✅ 3. Update Parent Selection
//       const updateParents = (child) => {
//         const parent = findParent(child.id, menuItems); // Find parent dynamically
//         if (!parent) return;
...
//         newSelectedItems[parent.id] = allChildrenChecked; // Update parent
  
//         updateParents(parent); // Recursively check grandparents
//       };
  
//       updateParents(item); // Start updating from clicked item
  
//       // ✅ 4. Update menuIds state
//       setMenuIds(() =>
...
//       const payload = {
//         roleCode,
//         menuIds: selectedMenuIds, // Use derived menuIds
//       };
...
//           <div className="menu-item-children ms-4">
