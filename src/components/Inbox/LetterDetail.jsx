...
const LetterDetail = ({
  ...
  const encloserFileName =
    letterDataView?.letterEnclosureArrays?.[0]?.fileName || "No File Available";
  const encloserFilePath =
    letterDataView?.letterEnclosureArrays?.[0]?.filePath || "No File Available";
  ...
  const [isConfidential, setIsConfidential] = useState(
    letterDataView?.isConfidentialfalse || false
  );
    ...
    try {
      ...
      if (response.status === 200 && response.data.outcome) {
        if (Array.isArray(response.data.data)) {
          ...
          console.error(
            "Unexpected data format in API response:",
            response.data.data
          );
          setTableData([]);
        }
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (typeof fetchedData.letterDetails === "string") {
          ...
          console.error(
            "Unexpected letterDetails format:",
            fetchedData.letterDetails
          );
        }
      }
    ...
    <>
      ...
      <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
            ...
            <Box>
              ...
              {showAllDetails && (
                <>
                  ...
                  <TextareaAutosize
                    aria-label="marginal instructions"
                    minRows={2}
                    placeholder="Enter marginal instructions here..."
                    value={marginalNote}
                ...
                <>
                  ...
                  >
                    <Table size="small" sx={{ border: "1px solid #e0e0e0" }}>
                      ...
                      <TableBody>
                        {letterDataView?.letterFrequentlyMarkObj?.map(
                          (mark) => (
                            <TableRow
                            ...
                            >
                              ...
                              >
                                <Checkbox
                                  checked={selectedRowsfrequ.includes(
                                    mark.empDeptMapId
                                  )}
                                  onChange={(event) =>
                                    handleCheckboxfrequientlyChange(
                                      event,
                                      mark.empDeptMapId
                                    )
                                  }
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        sx={{
                          "& .MuiSwitch-thumb": {
                            backgroundColor: isUrgent ? "green" : "gray",
                          },
                        }}
                      />
                    }
                  ...
                  <FormControlLabel
                    control={
                      <Switch
                        ...
                        sx={{
                          "& .MuiSwitch-thumb": {
                            backgroundColor: isConfidential ? "green" : "gray",
                          },
                        }}
                      />
                    }
              ...
              {showAllDetails && (
                <Box sx={{ display: "flex", gap: 2, mt: 3 }}>
                  ...
                  <Button
                    ...
                    disabled={
                      !letterDataView?.letterFrequentlyMarkObj ||
                      letterDataView.letterFrequentlyMarkObj.length === 0
          ...
          >
            ...
            <Box>
              ...
              <TableContainer component={Paper} variant="outlined">
                <Table
                  size="small"
                  sx={{ border: "1px solidrgb(224, 224, 224)" }}
                >
                  <TableHead>
                    <TableRow sx={{ bgcolor: "#1a5f6a" }}>
                      <TableCell
                  ...
                  <TableBody>
                    {letterDataView?.letterEnclosureArrays?.length > 0 ? (
                      letterDataView.letterEnclosureArrays.map(
                        (enclosure, index) => (
                          <TableRow
                            key={index}
                            sx={{
        ...
        <Dialog open={openUrgentModal} onClose={handleCancelUrgent}>
          ...
          >
            {pendingUrgency ? "Set as Urgent" : "Set as Non-Urgent"}
          </DialogTitle>
          {/* <IconButton onClick={handleCancelUrgent} sx={{ color: "white" }}>
          <CloseIcon/>
        </IconButton> */}
          <DialogContent>
            Do you want to make the letter{" "}
            {pendingUrgency ? "Urgent" : "Non-Urgent"}?
          </DialogContent>
          <DialogActions
            sx={{
        ...
        <Dialog open={openConfidentialModal} onClose={handleCancelConfidential}>
          ...
          <DialogContent>
            Do you want to make the letter{" "}
            {pendingConfidential ? "Confidential" : "Non-Confidential"}?
          </DialogContent>
          <DialogActions
            sx={{
        ...
        <Modal open={openModalotherbutton} onClose={handleCloseModal}>
          ...
          >
            ...
            <Grid container spacing={2} sx={{ mb: 2, p: 3 }}>
              ...
              <Grid item xs={6}>
                <FormControl fullWidth>
                  <InputLabel id="department-name-label">
                      ...
                      <TableRow key={row.empOfcDeptMapId}>
                        <TableCell>
                          <Checkbox
                            ...
                            onChange={(event) =>
                              handleCheckboxChange(event, row.empOfcDeptMapId)
                            }
                          />
                        </TableCell>
